...
SplitString(const std::string_view& str, const std::string_view& seps, bool remove_empty_entries)
{
...
bool IsPunct(char32_t c)
{
    ...
    if ((c >= 33 && c <= 47) || (c >= 58 && c <= 64) || (c >= 91 && c <= 96) || (c >= 123 && c <= 126)
        || (c >= 182 && c <= 183) || (c >= 8208 && c <= 8231) || (c >= 8240 && c <= 8259) || (c >= 8261 && c <= 8273)
        || (c >= 8275 && c <= 8286) || (c >= 12289 && c <= 12291) || (c >= 12296 && c <= 12305)
        || (c >= 12308 && c <= 12319)) {
        return true;
    }
...
bool IsControl(char32_t c)
{
    ...
    if ((c >= 0 && c <= 8) || (c >= 11 && c <= 12) || (c >= 14 && c <= 31) || (c >= 128 && c <= 159)
        || (c >= 888 && c <= 889) || (c >= 896 && c <= 899) || (c >= 8203 && c <= 8207) || (c >= 8234 && c <= 8238)
        || (c >= 8288 && c <= 8302) || (c >= 12020 && c <= 12030) || (c >= 40957 && c <= 40958)
        || (c >= 64110 && c <= 64111) || (c >= 64218 && c <= 64254) || (c >= 177973 && c <= 177982)
        || (c >= 178206 && c <= 178207) || (c >= 183970 && c <= 183982)) {
        return true;
    }
